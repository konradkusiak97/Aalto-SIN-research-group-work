...
from PPSTM_simple import newPPSTM_simple, conv2float, importData
...
############################# Button methods (more complex) ####################################
    ...
    def plotAtoms( self, atoms, atomSize=0.1, edge=True, ec='k'):
        plt.fig = plt.gcf()
    ...
    def plotGeom( self, atoms=None, atomSize=0.1 ):
        if atoms is not None:
            self.plotAtoms(atoms, atomSize=atomSize)
    ...
    def plotImage(self, plotData, height, voltage, mapType):
        ...
        # ploting part here:
            ...
            self.plotGeom(atoms=plotData['geom_plot'])
